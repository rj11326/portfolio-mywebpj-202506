...
| ---- | ---- | ------- | -------- | ---------------- | -------- | ------- | ------- |
| id | bigint unsigned |  | false | auto_increment | [applications](applications.md) [educations](educations.md) [licenses](licenses.md) [saved_jobs](saved_jobs.md) [work_histories](work_histories.md) |  |  |
