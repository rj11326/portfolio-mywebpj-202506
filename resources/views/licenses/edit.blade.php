...
<div class="max-w-3xl mx-auto py-10 px-4"
    ...
    <h1 class="text-2xl font-bold mb-6">資格の編集</h1>
    ...
    <form action="{{ route('licenses.update', $license->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ old('name', $license->name) }}"
        ...
        <div class="mb-4">
            ...
            <input type="date" name="acquired_date" value="{{ old('acquired_date', $license->acquired_date) }}"
