...
@section('content')
<div class="max-w-3xl mx-auto bg-white rounded-lg shadow px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div>
            ...
            <div class="mb-2"><span class="font-semibold">住所：</span> {{ $application->user->address ?? '---' }}</div>
        </div>
    </div>
    ...
    <div class="mt-8">
        <form method="POST" action="{{ route('company.applications.memo', $application->id) }}">
            ...
            <button type="submit" class="mt-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">保存</button>
        </form>
    </div>
</div>
@endsection